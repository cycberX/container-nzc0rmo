...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nzc0rmo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nzc0rmo.containers.anotherwebservice.com/
...
```
git clone git@github.com:cycberX/container-nzc0rmo.git
cd container-nzc0rmo
```
...
```
docker attach container-nzc0rmo
```
